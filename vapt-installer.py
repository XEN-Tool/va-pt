# =============================================================================
# XENO REDTOOL KIT - Vulnerability Assessment and Penetration Testing Toolkit
# =============================================================================
#
# Author: HASH_XXX
# Discord: https://discord.gg/B7T5gvyF8k
# 
# 
#
# RED-TOOL License Agreement
# 
# 1. This software is provided for legal cybersecurity and educational purposes only.
# 2. You may not use this tool to perform any illegal activity or unauthorized access.
# 3. Redistribution is allowed only in its original, unmodified form.
# 4. You must give credit to the original developer: HASH_XXX.
# 5. Modifying or selling this software without permission is strictly prohibited.
# 6. The author is not responsible for any misuse or damages caused by this software.
# 7. Users must comply with all applicable local, national, and international laws.
# 8. No warranty is provided; use at your own risk.
# 9. By using this software, you agree to these terms.
# 10. For questions or support, contact Discord: https://discord.gg/B7T5gvyF8k
# NOTICE : This tool is only for security purposes.If you use it improperly, I am not responsible.
# =============================================================================
        ...
        .+**+=:.:+=.:%++=+@-:-+::@#=@:..@.=.....=.#=:...:..%.....*@%:.:..#*-%:-+...+-=*%%%%#:.      
         ...
         ++%@@+-+*==#-.-- .#*+@+:@%.#.@@%:+.:=....+...:#:.+.***..+*=+@:@@@%@....-#=*#*=:::%%.       
          ..... =@--%#..-+%:@@@@@@..#:@@@.#.*@+.#*....::.@@.%-#..+..-:@@@@@.%-..#-.**.....          
             ...
             mmm  mmm  mmmmmmmm  mmm   mm    mmmm              mmmmmmmm    mmmm      mmmm    mm       
              ##mm##   ##""""""  ###   ##   ##""##             """##"""   ##""##    ##""##   ##       
               ####    ##        ##"#  ##  ##    ##               ##     ##    ##  ##    ##  ##       
                ##     #######   ## ## ##  ##    ##               ##     ##    ##  ##    ##  ##       
               ####    ##        ##  #m##  ##    ##   #####       ##     ##    ##  ##    ##  ##       
              ##  ##   ##mmmmmm  ##   ###   ##mm##                ##      ##mm##    ##mm##   ##mmmmmm 
             """  """  """"""""  ""   """    """"                 ""       """"      """"    """""""" 
